...
const HomePage = () => {
  return (
    <section className="w-full mx-auto">
      {/* Hero Section */}
      <div className="hero w-full flex flex-col gap-2 items-center">
        <div className="info w-full flex flex-col gap-2 items-center mt-12">
          <h1 className="text-2xl font-bold">01702 292 200</h1>
          <h1 className="text-2xl font-bold">7 days a week 4:30pm -10pm</h1>
        ...
        <img src="/hero.png" alt="hero-image" className="max-h-[550px]" />
      </div>
      ...
      <div className="flex flex-col md:flex-row items-center justify-center text-white py-12 px-6 md:px-12">
        ...
        >
          ...
          <p className="text-secondary text-sm mt-4">
            ...
            Southend-On-Sea. We believe every dish should feel like an embrace.
      ...
      {/* CTA section */}
      <div className="cta w-[100dvw] flex flex-col items-center justify-center gap-4 bg-[#D19B22] h-[350px] mt-4">
        ...
        <div className="div flex flex-row gap-2">
          <a
            href="#"
            className="uppercase text-primary bg-white rounded px-8 py-4"
          >
            Sign up
          </a>
          <a
            href="#"
            className="uppercase text-white bg-transparent border border-white rounded px-8 py-4"
          >
            View Menu{" "}
          </a>
        </div>
      ...
      <div className="flex flex-col md:flex-row items-center justify-center text-white py-12 px-6 md:px-12">
        ...
        <div className="w-full md:w-1/2 mt-8 md:mt-0 md:pl-12">
          ...
          <ul className="space-y-5 mb-10">
            <li className="flex items-center space-x-3 text-gray-300">
              ...
              <div className="flex flex-col">
                ...
                <h3 className="text-secondary text-xl">01702 292 200</h3>
              </div>
            </li>
          ...
          <div className="flex space-x-4">
            <button className="bg-yellow-600 hover:bg-yellow-700 text-white font-semibold py-3 px-8 rounded-lg flex items-center space-x-2 transition">
              <span>ORDER NOW</span>
              <ArrowRight className="w-5 h-5" />
            </button>

            <button className="border border-yellow-600 hover:bg-yellow-600 hover:text-white text-yellow-500 font-semibold py-3 px-8 rounded-lg transition">
              VIEW MENU
            </button>
          </div>
        </div>
